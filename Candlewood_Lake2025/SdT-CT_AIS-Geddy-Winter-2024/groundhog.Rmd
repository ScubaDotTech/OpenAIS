...
nearest_eco_indices <- st_nearest_feature(eco_data, eco_data)

eco_base$substrate.code[is.na(eco_base$substrate.code)] <- eco_base$substrate.code[nearest_indices][is.na(eco_base$substrate.code)]
...
eco_base <- eco_base %>% 
  ...
  select(year, transect, lattitude, longitude, depth_m_, dfs_m_, substrate.code, point, 
...
eco_jit <- eco_base %>% select(transect, point, lattitude, longitude, year, depth_m_, dfs_m_, substrate.code, june_temp, june_dew_point, precipitation, point_sum_myrspi, point_sum_cerdem, point_sum_others) 
