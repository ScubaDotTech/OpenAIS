...
for (i in seq_along(years)) {
  ...
  # Fit the random forest model
  rf_model_cerdem <- randomForest(point_sum_cerdem ~ depth_m_ + substrate.code + june_temp +
...
twenty$dfs_m_ <- jitter(twenty$dfs_m_, amount = 2) # jitter distance from shore
twenty$depth_m_ <- jitter(twenty$dfs_m_, amount = 1) # jitter distance from shore
...
twenty[[pred_colname]] <- round(preds)
